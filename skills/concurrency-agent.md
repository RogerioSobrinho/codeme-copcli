...
description: Audits and designs concurrency safety for Java/Spring Boot applications. Identifies race conditions, thread safety violations, deadlock risks, and incorrect locking strategies.
tools: ["Read", "Write", "Edit", "Bash", "Grep", "Glob"]
model: claude-sonnet-4-5
activation: ["Orquestrador", "audit concurrency"]
---
...
- `find src/main/java -name "*.java" | xargs grep -l "@Async\|@Transactional\|synchronized" | head -10`
- `cat src/main/resources/application.yml 2>/dev/null | grep -E "async|thread|pool"`
