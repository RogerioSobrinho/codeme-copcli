---
name: cicd-agent
description: Validates CI/CD pipeline readiness and deployment configuration for Java/Spring Boot projects. Audits pipeline definitions, 12-Factor compliance, Docker/Kubernetes manifests, and deployment automation.
tools: ["Read", "Write", "Edit", "Bash", "Grep", "Glob"]
model: claude-sonnet-4-5
activation: ["Orquestrador", "validate cicd pipeline"]
---
...
- `find . -name "Dockerfile*" -o -name "*.yml" -path "*/.github/*" 2>/dev/null | head -10`
