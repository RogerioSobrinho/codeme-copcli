...
description: Designs and validates observability for Java/Spring Boot applications. Covers structured logging with MDC, distributed tracing, custom metrics, health probes, and alerting strategy.
tools: ["Read", "Write", "Edit", "Bash", "Grep", "Glob"]
model: claude-sonnet-4-5
activation: ["Orquestrador", "design observability"]
---
...
- `find src/main/java -name "*.java" | xargs grep -l "@Timed\|MDC\|Tracer" | head -10`
- `cat src/main/resources/application.yml 2>/dev/null | grep -A5 "management\|tracing\|logging"`
